    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-gray-100 flex items-center justify-center py-12 px-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md border-t-4 border-yellow-500">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input type="email" required value={formData.email} onChange={(e) => setFormData({...formData, email: e.target.value})}
              className="w-full border-2 border-gray-200 rounded-lg px-4 py-3 focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition"
          ...
          <div>
            ...
            <div className="relative">
              <input 
                ...
                className="w-full border-2 border-gray-200 rounded-lg px-4 py-3 pr-12 focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition"
                placeholder="••••••••" 
              />
              <button
                type="button"
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600">Pas encore de compte ? <Link href="/register" className="text-yellow-600 hover:text-yellow-700 font-bold">S'inscrire</Link></p>
        </div>
      </div>
    </div>
  );
...
export default function LoginPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-gray-100 flex items-center justify-center">
